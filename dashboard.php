...
<html lang="rs">
   <head>
    ...
    <link href="dashboard/dashboard/vendor/animsition/animsition.min.css" rel="stylesheet" media="all">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
						...
						<div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
                                    <p style="font-size: 16px;">&copy; 2020 <em>CRUD Material</em> | Podrži projekte otvorenog koda 
									<a style="font-size: 16px;" href="https://github.com/owlCoder">GitHub</a>
									</p>
                                </div>
                            </div>
                        </div>
